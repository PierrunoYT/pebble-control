...
contextBridge.exposeInMainWorld('pebble', {
  ...
  setShortcuts: (changes) => ipcRenderer.invoke('app:set-shortcuts', changes),
  resetShortcuts: () => ipcRenderer.invoke('app:reset-shortcuts'),
  getSettings: () => ipcRenderer.invoke('app:get-settings'),
  setSettings: (changes) => ipcRenderer.invoke('app:set-settings', changes),
  ...
  applySoundMode: (id, output) => ipcRenderer.invoke('effects:apply-sound-mode', id, output),
