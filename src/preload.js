...
contextBridge.exposeInMainWorld('pebble', {
  ...
  saveSoundMode: (name, output) => ipcRenderer.invoke('effects:save-sound-mode', name, output),
  deleteSoundMode: (id, output) => ipcRenderer.invoke('effects:delete-sound-mode', id, output),
  resetSoundMode: (id, output) => ipcRenderer.invoke('effects:reset-sound-mode', id, output),
  getMicEqState: () => ipcRenderer.invoke('mic-eq:get-state'),
  setMicEq: (changes) => ipcRenderer.invoke('mic-eq:set', changes),
